...
#define LV_ATTRIBUTE_MEM_ALIGN __attribute__((aligned(4))) /* With size optimization (-Os) the compiler might not align data to 4 or 8 byte boundary. This alignment will be explicitly applied where needed.*/
